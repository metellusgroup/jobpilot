                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="icon-box">
                                        ...
                                        <h3 class="sub-title">{{ __('noc_available') }}</h3>
                                        <h2 class="title" id="candidate_noc_available">N/A</h2>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="icon-box">
                                        ...
                                        <h3 class="sub-title">{{ __('driving_license') }}</h3>
                                        <h2 class="title" id="candidate_driving_license">N/A</h2>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="icon-box">
                                        <div class="icon-img">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path stroke="var(--primary-500)" stroke-width="1.5"
                                                    stroke-linecap="round" stroke-linejoin="round"
                                                    d="M6.32 2.577a49.255 49.255 0 0 1 11.36 0c1.497.174 2.57 1.46 2.57 2.93V21a.75.75 0 0 1-1.085.67L12 18.089l-7.165 3.583A.75.75 0 0 1 3.75 21V5.507c0-1.47 1.073-2.756 2.57-2.93Z" />
                                            </svg>
                                        </div>
                                        <h3 class="sub-title">{{ __('visa_status') }}</h3>
                                        <h2 class="title" id="candidate_visa_status">N/A</h2>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="icon-box">
                                        ...
                                        <h2 class="title" id="candidate_language">N/A</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
